...
- [Code Validation](#code-validation)
  - [Schrödinger Solver Validation](#schrödinger-solver-validation)
  - [Poisson Solver Validation](#poisson-solver-validation)
- [Results](#results)
...
To ensure the reliability of the numerical solvers the codebase includes a validation analysis that compares the numerical results against known analytical solutions for hydrogen-like systems.
...
$$
u_\mathrm{exact}\propto r e^{-Zr}
$$

As shown in the figure, the numerical solution (blue line) overlaps perfectly with the analytical formula (orange dashed line), confirming the correct implementation.
